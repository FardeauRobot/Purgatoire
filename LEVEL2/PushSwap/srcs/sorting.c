...
/*   Updated: 2025/12/20 17:04:13 by tibras           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_list	*ft_find_target(t_list **stack_a, t_node *n_b)
{
	t_node	*n_a;
	t_node	*n_target;
	t_list	*l_a;
...
void	ft_affect_target(t_list **stack_a, t_list **stack_b)
{
	...
	while (l_b)
	{
		...
		n_b->target = ft_find_target(stack_a, n_b);
		l_b = l_b->next;
	}
}
