...
1. [Why two different pointer types?](#1-why-two-different-pointer-types)
2. [Declaring a member function pointer](#2-declaring-a-member-function-pointer)
3. [Taking the address](#3-taking-the-address)
4. [Calling through the pointer](#4-calling-through-the-pointer)
5. [The classic use case — dispatch tables](#5-the-classic-use-case--dispatch-tables)
6. [Virtual methods and member pointers](#6-virtual-methods-and-member-pointers)
7. [`static` member functions are not members](#7-static-member-functions-are-not-members)
8. [`typedef` to tame the syntax](#8-typedef-to-tame-the-syntax)
9. [Common errors](#9-common-errors)
10. [In CPP01](#10-in-cpp01)
...
- [`modules/CPP01.md`](../modules/CPP01.md) — Harl exercise walkthrough.
