...
- **`std::string`** member functions — see [STRING_FUNCTIONS.md](../../notions/io-errors/STRING_FUNCTIONS.md) in this directory.
- **Orthodox Canonical Form** — see [ORTHODOX_CANONICAL_FORM.md](../../notions/oop/ORTHODOX_CANONICAL_FORM.md).
