...
1. [A Short History of C++](#1.%20A%20Short%20History%20of%20C%2B%2B)
2. [The Philosophy of C++ (and Why It Matters)](#2.%20The%20Philosophy%20of%20C%2B%2B%20%28and%20Why%20It%20Matters%29)
3. [What C++ is Used For](#3.%20What%20C%2B%2B%20is%20Used%20For)
4. [The Mental Shift from C to C++](#4.%20The%20Mental%20Shift%20from%20C%20to%20C%2B%2B)
5. [What Stays the Same](#5.%20What%20Stays%20the%20Same)
6. [What is New — A Guided Tour](#6.%20What%20is%20New%20%E2%80%94%20A%20Guided%20Tour)
7. [How C++ Code Becomes a Program](#7.%20How%20C%2B%2B%20Code%20Becomes%20a%20Program)
8. [Memory Model & Object Lifetime](#8.%20Memory%20Model%20%26%20Object%20Lifetime)
9. [Classes — The Core Concept](#9.%20Classes%20%E2%80%94%20The%20Core%20Concept)
10. [Orthodox Canonical Form](#10.%20Orthodox%20Canonical%20Form)
11. [References](#11.%20References)
12. [`new` / `delete` — and What Happens in Memory](#12.%20new%20%2F%20delete%20%E2%80%94%20and%20What%20Happens%20in%20Memory)
13. [`const` Correctness](#13.%20const%20Correctness)
14. [`static` — Three Meanings, One Keyword](#14.%20static%20%E2%80%94%20Three%20Meanings%2C%20One%20Keyword)
15. [Namespaces](#15.%20Namespaces)
16. [Operator Overloading](#16.%20Operator%20Overloading)
17. [Inheritance](#17.%20Inheritance)
18. [Polymorphism & Virtual Functions](#18.%20Polymorphism%20%26%20Virtual%20Functions)
19. [Exceptions](#19.%20Exceptions)
20. [Templates](#20.%20Templates)
21. [The STL (Standard Template Library)](#21.%20The%20STL%20%28Standard%20Template%20Library%29)
22. [I/O Streams](#22.%20I%2FO%20Streams)
23. [Casts](#23.%20Casts)
24. [Undefined Behavior — The Sharp Edge of C++](#24.%20Undefined%20Behavior%20%E2%80%94%20The%20Sharp%20Edge%20of%20C%2B%2B)
25. [Tips That Make Things Click](#25.%20Tips%20That%20Make%20Things%20Click)
26. [Common Pitfalls & How to Spot Them](#26.%20Common%20Pitfalls%20%26%20How%20to%20Spot%20Them)
27. [An Effective Learning Path](#27.%20An%20Effective%20Learning%20Path)
28. [Glossary](#28.%20Glossary)
...
| **`std::string`** | Self-managing string type (see [STRING_FUNCTIONS.md](../../notions/io-errors/STRING_FUNCTIONS.md)) | `char*` + `malloc`/`free` |
...
See [ORTHODOX_CANONICAL_FORM.md](../../notions/oop/ORTHODOX_CANONICAL_FORM.md) for the deep dive. Short version:
...
See [REFERENCE.md](../../notions/fundamentals/REFERENCE.md) for the full guide. Short version:
...
See [ERROR_MANAGEMENT.md](../../notions/io-errors/ERROR_MANAGEMENT.md) for a full treatment, including every standard exception class. Summary:
...
See [LIBRARIES.md](../../notions/tooling/LIBRARIES.md), [FSTREAM_GUIDE.md](../../notions/io-errors/FSTREAM_GUIDE.md), and [OPEN.md](../../notions/io-errors/OPEN.md) for details. Summary:
...
It has a constructor. It has a destructor. It does heap allocation. Passing it by value **copies** the heap buffer. **Always pass it as `const std::string&`** unless you explicitly need a copy. For the full API (find, substr, compare, append, …) see [STRING_FUNCTIONS.md](../../notions/io-errors/STRING_FUNCTIONS.md).
