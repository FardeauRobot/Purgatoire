...
Full write-up: [`oop/ORTHODOX_CANONICAL_FORM.md`](../../notions/oop/ORTHODOX_CANONICAL_FORM.md).
...
See [`oop/OPERATOR_OVERLOADING.md`](../../notions/oop/OPERATOR_OVERLOADING.md).
...
- `operator+` returns by **value** (fresh temporary); `operator=`
  ...
  read [`oop/OPERATOR_OVERLOADING.md §5`](../../notions/oop/OPERATOR_OVERLOADING.md).
