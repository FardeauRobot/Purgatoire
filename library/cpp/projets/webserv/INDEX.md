...
Already building? Jump to the [**By implementation part**](#%F0%9F%A7%A9%20By%20implementation%20part) view below — the same files regrouped by the module you're working on.
...
- [`cpp/io-errors/FSTREAM_GUIDE.md`](../../notions/io-errors/FSTREAM_GUIDE.md) — you'll be doing a lot of streaming I/O in webserv.
- [`cpp/tooling/MAKEFILE_CPP.md`](../../notions/tooling/MAKEFILE_CPP.md) — webserv is multi-file; a clean Makefile is non-negotiable.
