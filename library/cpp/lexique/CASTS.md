...
> **Keyword zoom-ins:** [`TYPEID`](TYPEID.md) · [`CONST`](CONST.md) · [`EXPLICIT`](EXPLICIT.md)
...
1. [Why C casts are a problem](#1.%20Why%20C%20casts%20are%20a%20problem)
...
6. [Side-by-side comparison](#6.%20Side-by-side%20comparison)
7. [Which cast to reach for](#7.%20Which%20cast%20to%20reach%20for)
8. [RTTI — `typeid` and `dynamic_cast`](#8.%20RTTI%20%E2%80%94%20typeid%20and%20dynamic_cast)
9. [In CPP06](#9.%20In%20CPP06)
10. [Gotchas](#10.%20Gotchas)
