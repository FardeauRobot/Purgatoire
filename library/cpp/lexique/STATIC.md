...
Related: [`CONST.md`](CONST.md) · [`EXTERN.md`](EXTERN.md) · [`BASICS.md`](../notions/fundamentals/BASICS.md#11.%20static%20members) · [`MEMORY.md`](../notions/fundamentals/MEMORY.md)
...
`static_cast<T>(x)` reuses the keyword for a different feature — compile-time casting. See [`CASTS.md`](CASTS.md). Don't conflate them.
