...
Related: [`ENUM.md`](ENUM.md) · [`BOOL.md`](BOOL.md) · [`MEMBER_FUNCTION_POINTERS.md`](../notions/advanced/MEMBER_FUNCTION_POINTERS.md) (the alternative pattern)
...
| dispatch table | Mapping a value (any type) to a *function*. See [`MEMBER_FUNCTION_POINTERS.md`](../notions/advanced/MEMBER_FUNCTION_POINTERS.md). |
