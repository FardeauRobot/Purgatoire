...
> **Keyword zoom-ins:** [`VIRTUAL`](../../lexique/VIRTUAL.md) · [`TYPEID`](../../lexique/TYPEID.md)
...
1. [Two kinds of polymorphism](#1.%20Two%20kinds%20of%20polymorphism)
2. [The `virtual` keyword](#2.%20The%20virtual%20keyword)
3. [Static vs dynamic dispatch](#3.%20Static%20vs%20dynamic%20dispatch)
4. [The vtable — how it works in memory](#4.%20The%20vtable%20%E2%80%94%20how%20it%20works%20in%20memory)
5. [Pure virtual functions and abstract classes](#5.%20Pure%20virtual%20functions%20and%20abstract%20classes)
6. [Interfaces in C++](#6.%20Interfaces%20in%20C%2B%2B)
7. [The virtual destructor rule](#7.%20The%20virtual%20destructor%20rule)
8. [Object slicing — the silent killer](#8.%20Object%20slicing%20%E2%80%94%20the%20silent%20killer)
9. [Calling virtuals from ctors/dtors](#9.%20Calling%20virtuals%20from%20ctors%2Fdtors)
10. [The cost of virtual](#10.%20The%20cost%20of%20virtual)
11. [In CPP04](#11.%20In%20CPP04)
...
This guide is about the second kind. For templates (ad-hoc), see [TEMPLATES.md](../advanced/TEMPLATES.md).
...
- **`dynamic_cast` requires a polymorphic base** (at least one virtual). See [CASTS.md](../../lexique/CASTS.md).
