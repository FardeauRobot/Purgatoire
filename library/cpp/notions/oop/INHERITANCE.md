...
> **Keyword zoom-ins:** [`PUBLIC/PRIVATE/PROTECTED`](../../lexique/PUBLIC_PRIVATE_PROTECTED.md) · [`VIRTUAL`](../../lexique/VIRTUAL.md) · [`USING`](../../lexique/USING.md)
...
1. [Why inheritance exists](#1.%20Why%20inheritance%20exists)
2. [Syntax and the three access modes](#2.%20Syntax%20and%20the%20three%20access%20modes)
3. [`protected` — the middle ground](#3.%20protected%20%E2%80%94%20the%20middle%20ground)
4. [Construction and destruction order](#4.%20Construction%20and%20destruction%20order)
5. [Calling the parent's constructor](#5.%20Calling%20the%20parent%27s%20constructor)
6. [Memory layout](#6.%20Memory%20layout)
7. [Upcasting and downcasting](#7.%20Upcasting%20and%20downcasting)
8. [Name hiding](#8.%20Name%20hiding)
9. [Multiple inheritance](#9.%20Multiple%20inheritance)
10. [The diamond problem and virtual inheritance](#10.%20The%20diamond%20problem%20and%20virtual%20inheritance)
11. [Composition vs inheritance](#11.%20Composition%20vs%20inheritance)
12. [In CPP03 — ClapTrap family](#12.%20In%20CPP03%20%E2%80%94%20ClapTrap%20family)
13. [In CPP04 — polymorphic hierarchies](#13.%20In%20CPP04%20%E2%80%94%20polymorphic%20hierarchies)
14. [Rules of thumb](#14.%20Rules%20of%20thumb)
15. [Gotchas](#15.%20Gotchas)
...
Use `dynamic_cast` whenever you can't prove at compile time that `a` is a `Dog`. See [CASTS.md](../../lexique/CASTS.md).
