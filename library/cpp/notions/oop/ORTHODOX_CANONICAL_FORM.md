...
> **Keyword zoom-ins:** [`OPERATOR`](../../lexique/OPERATOR.md) · [`THIS`](../../lexique/THIS.md) · [`EXPLICIT`](../../lexique/EXPLICIT.md) · [`CONST`](../../lexique/CONST.md) · [`NEW`](../../lexique/NEW.md) · [`DELETE`](../../lexique/DELETE.md)

## Table of Contents
1. [What is the Orthodox Canonical Form?](#What%20is%20the%20Orthodox%20Canonical%20Form%3F)
2. [Why does it exist?](#Why%20does%20it%20exist%3F)
3. [The Four Mandatory Members](#The%20Four%20Mandatory%20Members)
   - [1. Default Constructor](#1.%20Default%20Constructor)
   - [2. Copy Constructor](#2.%20Copy%20Constructor)
   - [3. Copy Assignment Operator](#3.%20Copy%20Assignment%20Operator)
   - [4. Destructor](#4.%20Destructor)
4. [The Rule of Three (and Five, and Zero)](#The%20Rule%20of%20Three%20%28and%20Five%2C%20and%20Zero%29)
5. [Deep Copy vs Shallow Copy](#Deep%20Copy%20vs%20Shallow%20Copy)
6. [Common Pitfalls](#Common%20Pitfalls)
7. [Full Examples](#Full%20Examples)
