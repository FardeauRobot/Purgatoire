...
> **Keyword zoom-ins:** [`OPERATOR`](../../lexique/OPERATOR.md) · [`FRIEND`](../../lexique/FRIEND.md) · [`EXPLICIT`](../../lexique/EXPLICIT.md)
...
1. [Why overload operators?](#1.%20Why%20overload%20operators%3F)
2. [The list of overloadable operators](#2.%20The%20list%20of%20overloadable%20operators)
3. [Member vs non-member](#3.%20Member%20vs%20non-member)
4. [Canonical signatures](#4.%20Canonical%20signatures)
5. [Arithmetic operators](#5.%20Arithmetic%20operators)
6. [Compound assignment (`+=`, `-=`, …)](#6.%20Compound%20assignment%20%28%2B%3D%2C%20-%3D%2C%20%E2%80%A6%29)
7. [Comparison operators](#7.%20Comparison%20operators)
8. [Increment and decrement (prefix vs postfix)](#8.%20Increment%20and%20decrement%20%28prefix%20vs%20postfix%29)
9. [Stream insertion and extraction (`<<`, `>>`)](#9.%20Stream%20insertion%20and%20extraction%20%28%3C%3C%2C%20%3E%3E%29)
10. [Subscript `[]`, function call `()`](#10.%20Subscript%20%5B%5D%2C%20function%20call%20%28%29)
11. [Assignment operator `=`](#11.%20Assignment%20operator%20%3D)
12. [Conversion operators](#12.%20Conversion%20operators)
13. [In CPP02 — the Fixed class](#13.%20In%20CPP02%20%E2%80%94%20the%20Fixed%20class)
