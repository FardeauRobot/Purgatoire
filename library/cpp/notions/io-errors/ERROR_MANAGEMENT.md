...
> **Keyword zoom-in:** [`TRY/CATCH/THROW`](../../lexique/TRY_CATCH_THROW.md)
...
1. [The Three Strategies](#1.%20The%20Three%20Strategies)
2. [Return Codes](#2.%20Return%20Codes)
3. [Stream State Checks](#3.%20Stream%20State%20Checks)
4. [Exceptions — The Basics](#4.%20Exceptions%20%E2%80%94%20The%20Basics)
5. [What Actually Happens When You `throw`](#5.%20What%20Actually%20Happens%20When%20You%20throw)
6. [The Standard Exception Hierarchy](#6.%20The%20Standard%20Exception%20Hierarchy)
7. [Every Standard Exception Class, Explained](#7.%20Every%20Standard%20Exception%20Class%2C%20Explained)
8. [Catching — Best Practices](#8.%20Catching%20%E2%80%94%20Best%20Practices)
9. [Rethrowing](#9.%20Rethrowing)
10. [Custom Exception Classes](#10.%20Custom%20Exception%20Classes)
11. [Exceptions in Constructors](#11.%20Exceptions%20in%20Constructors)
12. [Exceptions in Destructors — Danger Zone](#12.%20Exceptions%20in%20Destructors%20%E2%80%94%20Danger%20Zone)
13. [`throw` Specifications (C++98) and `noexcept` (modern)](#13.%20throw%20Specifications%20%28C%2B%2B98%29%20and%20noexcept%20%28modern%29)
14. [Exception Safety Guarantees](#14.%20Exception%20Safety%20Guarantees)
15. [Performance — The Real Cost](#15.%20Performance%20%E2%80%94%20The%20Real%20Cost)
16. [When to Use Exceptions (and When Not To)](#16.%20When%20to%20Use%20Exceptions%20%28and%20When%20Not%20To%29)
17. [Common Pitfalls](#17.%20Common%20Pitfalls)
18. [Decision Cheat Sheet](#18.%20Decision%20Cheat%20Sheet)
19. [Template Project Utilities](#19.%20Template%20Project%20Utilities)
20. [TL;DR](#20.%20TL%3BDR)
