...
Related: [`STL.md`](../advanced/STL.md) · [`TEMPLATES.md`](../advanced/TEMPLATES.md) · [`MEMORY.md`](../fundamentals/MEMORY.md) · [`NEW.md`](../../lexique/NEW.md) · [`INDEX.md`](INDEX.md)
...
1. [Mental model — what a vector really is](#1.%20Mental%20model%20%E2%80%94%20what%20a%20vector%20really%20is)
2. [Construction](#2.%20Construction)
3. [Capacity — `size` vs `capacity`](#3.%20Capacity%20%E2%80%94%20size%20vs%20capacity)
4. [Element access](#4.%20Element%20access)
5. [Modifiers](#5.%20Modifiers)
6. [Iterators](#6.%20Iterators)
7. [Complexity cheat sheet](#7.%20Complexity%20cheat%20sheet)
8. [Iterator invalidation — the silent killer](#8.%20Iterator%20invalidation%20%E2%80%94%20the%20silent%20killer)
9. [Efficiency: ten tricks](#9.%20Efficiency%3A%20ten%20tricks)
10. [Algorithms that pair well with vector](#10.%20Algorithms%20that%20pair%20well%20with%20vector)
11. [`vector<bool>` — the cursed exception](#11.%20vector%3Cbool%3E%20%E2%80%94%20the%20cursed%20exception)
12. [When NOT to use vector](#12.%20When%20NOT%20to%20use%20vector)
13. [C++98 caveats](#13.%20C%2B%2B98%20caveats)
14. [Gotchas](#14.%20Gotchas)
...
**`clear()` does not free memory.** It only destroys elements. If you need to release the buffer, see the [swap trick](#9.%20Efficiency%3A%20ten%20tricks).
