...
Identical reasoning to [`STACK.md` §4](STACK.md#4.%20The%20pop%28%29-returns-void%20gotcha): C++98 separates *read* from *destroy* so a throwing copy can't lose data.
