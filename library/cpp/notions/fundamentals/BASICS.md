...
> **Keyword zoom-ins:** [`CLASS`](../../lexique/CLASS.md) · [`STRUCT`](../../lexique/STRUCT.md) · [`PUBLIC/PRIVATE/PROTECTED`](../../lexique/PUBLIC_PRIVATE_PROTECTED.md) · [`CONST`](../../lexique/CONST.md) · [`STATIC`](../../lexique/STATIC.md) · [`THIS`](../../lexique/THIS.md) · [`NAMESPACE`](../../lexique/NAMESPACE.md) · [`NEW`](../../lexique/NEW.md) · [`DELETE`](../../lexique/DELETE.md). Full keyword index: [`lexique/INDEX.md`](../../lexique/INDEX.md).
