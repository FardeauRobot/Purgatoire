...
> **Keyword zoom-ins:** [`INLINE`](../../lexique/INLINE.md) · [`EXTERN`](../../lexique/EXTERN.md) · [`STATIC`](../../lexique/STATIC.md)
...
1. [The canonical 42 C++ Makefile](#1.%20The%20canonical%2042%20C%2B%2B%20Makefile)
2. [Flags explained](#2.%20Flags%20explained)
3. [How `make` decides to rebuild](#3.%20How%20make%20decides%20to%20rebuild)
4. [The four mandatory rules](#4.%20The%20four%20mandatory%20rules)
5. [Header dependency tracking](#5.%20Header%20dependency%20tracking)
6. [Why templates break naive Makefiles](#6.%20Why%20templates%20break%20naive%20Makefiles)
7. [Object files in a build directory](#7.%20Object%20files%20in%20a%20build%20directory)
8. [Pattern rules and automatic variables](#8.%20Pattern%20rules%20and%20automatic%20variables)
9. [`.PHONY` — why it matters](#9.%20.PHONY%20%E2%80%94%20why%20it%20matters)
10. [Colors and progress output](#10.%20Colors%20and%20progress%20output)
11. [Debugging a Makefile](#11.%20Debugging%20a%20Makefile)
12. [Rules of thumb](#12.%20Rules%20of%20thumb)
13. [Gotchas](#13.%20Gotchas)
...
If you split templates into `Array.hpp` + `Array.tpp` (see [TEMPLATES.md §8](../advanced/TEMPLATES.md)), the `.tpp` is `#include`'d from the `.hpp`. `-MMD` picks up that chain — no extra Makefile work needed.
