...
1. [The philosophy](#1.%20The%20philosophy)
2. [Containers overview](#2.%20Containers%20overview)
...
7. [Iterator categories](#7.%20Iterator%20categories)
8. [Algorithms](#8.%20Algorithms)
9. [`std::pair` and `std::make_pair`](#9.%20std%3A%3Apair%20and%20std%3A%3Amake_pair)
10. [Functors — C++98's answer to lambdas](#10.%20Functors%20%E2%80%94%20C%2B%2B98%27s%20answer%20to%20lambdas)
11. [In CPP08 — iterators + templated containers](#11.%20In%20CPP08%20%E2%80%94%20iterators%20%2B%20templated%20containers)
12. [In CPP09 — picking the right container](#12.%20In%20CPP09%20%E2%80%94%20picking%20the%20right%20container)
13. [Cheatsheet: which container when](#13.%20Cheatsheet%3A%20which%20container%20when)
...
Technically a sequence container (it's `std::basic_string<char>`). See [STRING_FUNCTIONS.md](../io-errors/STRING_FUNCTIONS.md).
...
- **C++98 has no `std::unique_ptr`** — only `std::auto_ptr`, which is weird (see [MEMORY.md](../fundamentals/MEMORY.md#7.%20RAII%20%E2%80%94%20the%20central%20idea)) and avoid-unless-necessary.
