...
> **Keyword zoom-ins:** [`PUBLIC/PRIVATE/PROTECTED`](../keywords/PUBLIC_PRIVATE_PROTECTED.md) · [`CONST`](../keywords/CONST.md) · [`THIS`](../keywords/THIS.md) · [`MUTABLE`](../keywords/MUTABLE.md) · [`EXPLICIT`](../keywords/EXPLICIT.md)

## Table of Contents
1. [What are getters and setters?](#what-are-getters-and-setters)
2. [The mental model: encapsulation and class invariants](#the-mental-model-encapsulation-and-class-invariants)
3. [Minimal example](#minimal-example)
4. [Anatomy of a good getter](#anatomy-of-a-good-getter)
   - [Return by value, reference, or const reference?](#return-by-value-reference-or-const-reference)
   - [The trailing `const`](#the-trailing-const)
   - [Computed (derived) getters](#computed-derived-getters)
5. [Anatomy of a good setter](#anatomy-of-a-good-setter)
   - [Pass parameters by const reference](#pass-parameters-by-const-reference)
   - [Validation strategies](#validation-strategies)
6. [The `const` story (deep dive)](#the-const-story-deep-dive)
7. [When NOT to write a getter/setter](#when-not-to-write-a-gettersetter)
8. [Common pitfalls](#common-pitfalls)
9. [Naming conventions](#naming-conventions)
10. [Worked example — PhoneBook `Contact`](#worked-example--phonebook-contact)
11. [Decision tree / cheat sheet](#decision-tree--cheat-sheet)
...
[`mutable`](../keywords/MUTABLE.md) for fields like caches or mutexes that
