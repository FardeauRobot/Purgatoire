...
Related: [`BASICS.md`](../fundamentals/BASICS.md#10-const--much-more-powerful-than-in-c) · [`REFERENCE.md`](../fundamentals/REFERENCE.md) · [`STATIC.md`](STATIC.md) · [`MUTABLE.md`](MUTABLE.md)
