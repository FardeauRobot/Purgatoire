...
Related: [`DELETE.md`](DELETE.md) · [`MEMORY.md`](../fundamentals/MEMORY.md) · [`BASICS.md`](../fundamentals/BASICS.md#61-new--delete-instead-of-malloc--free)
...
Or implement OCF properly to allow copying. See [`MEMORY.md`](../fundamentals/MEMORY.md) and [`ORTHODOX_CANONICAL_FORM.md`](../oop/ORTHODOX_CANONICAL_FORM.md).
...
If you see "definitely lost," you have a `new` without a matching `delete`. See [`MEMORY.md`](../fundamentals/MEMORY.md).
