...
Related: [`VIRTUAL.md`](VIRTUAL.md) · [`CASTS.md`](../advanced/CASTS.md) · [`POLYMORPHISM.md`](../oop/POLYMORPHISM.md)
...
Not from `typeid` directly — from `dynamic_cast`. See [`CASTS.md`](../advanced/CASTS.md).
