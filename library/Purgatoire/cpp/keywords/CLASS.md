...
Related: [`STRUCT.md`](STRUCT.md) · [`PUBLIC_PRIVATE_PROTECTED.md`](PUBLIC_PRIVATE_PROTECTED.md) · [`THIS.md`](THIS.md) · [`BASICS.md`](../fundamentals/BASICS.md#7-classes--the-core-of-c) · [`ORTHODOX_CANONICAL_FORM.md`](../oop/ORTHODOX_CANONICAL_FORM.md)
...
The C++ compiler will **synthesize** any of the four OCF members you don't declare (default ctor, copy ctor, copy assignment, dtor) — but only if it can. See [`ORTHODOX_CANONICAL_FORM.md`](../oop/ORTHODOX_CANONICAL_FORM.md).
...
For RAII, see [`MEMORY.md`](../fundamentals/MEMORY.md). For OCF, see [`ORTHODOX_CANONICAL_FORM.md`](../oop/ORTHODOX_CANONICAL_FORM.md).
