...
/*   Updated: 2025/11/26 19:17:31 by tibras           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

int	ft_lllen(unsigned long long nb, int l_base)
{
	int					len;
...
char	*ft_fillll(unsigned long long nb, char *base, int l_base, int r_len)
{
	char	*res;
...
char	*ft_cust_lltoa(unsigned long long nb, int l_base, int mod)
{
	char	*base;
	char	*res;
	int		r_len;
